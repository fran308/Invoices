...
# Handle the different authentication states and prevent further script execution if not logged in
if st.session_state.get("authentication_status"):
    # If logged in successfully, show welcome message and logout button in the sidebar
    st.sidebar.success(f"✅ Welcome {st.session_state['name']}")
    authenticator.logout("Log off", location="sidebar")
...
# =========================================================
# MAIN APP (Only runs if authenticated due to st.stop() above)
# =========================================================
